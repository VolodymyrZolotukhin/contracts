...
import {GlpAdapter, IRewardTracker, IRewardRouterV2} from "../../../../src/vault/adapter/gmx/GlpAdapter.sol";

contract GlpAdapterTest is AbstractAdapterTest {
    ...
    function _setUpTest(bytes memory testConfig) internal {
        ...
        setUpBaseTest(
            ...
            address(new GlpAdapter()),
            0xA906F338CB21815cBc4Bc87ace9e68c87eF8d8F1,//router
            10,
            "GMX ",
            false
        );
        ...
        rewardTracker = IRewardTracker(router.stakedGlpTracker());
    ...
    function createAdapter() public override {
        adapter = IAdapter(Clones.clone(address(new GlpAdapter())));
